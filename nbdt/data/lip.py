...
class LookIntoPerson(BaseDataset):
    def __init__(self, 
        ...
        super(LookIntoPerson, self).__init__(ignore_label, base_size,
        ...
        self.classes = ['background', 'hat', 'hair', 'glove', 'sunglasses',
    ...
    def __getitem__(self, index):
        ...
        image = cv2.imread(os.path.join(
                    self.root, 'LookIntoPerson/TrainVal_images/', item["img"]), 
                    cv2.IMREAD_COLOR)
        label = cv2.imread(os.path.join(
                    self.root, 'LookIntoPerson/TrainVal_parsing_annotations/', 
                    item["label"]),
