...
class ADE20K(BaseDataset):
    def __init__(self, 
        ...
        self.img_list = [json.loads(x.rstrip()) for x in open(os.path.join(root,list_path), 'r')]

        self.files = self.read_files()
        if num_samples:
            self.files = self.files[:num_samples]

        self.classes = ["wall", "building", "sky", "floor", "tree", "ceiling", "road",
            ...
            "railing", "cushion", "pedestal", "box", "column", "signboard",
            ...
            "bench", "countertop", "stove", "palm_tree", "kitchen_island", "computer",
            "swivel_chair", "boat", "bar", "arcade_machine", "hovel", "bus", "towel",
            "light_source", "truck", "tower", "chandelier", "awning", "streetlight",
            "booth", "television_receiver", "airplane", "dirt_track", "apparel",
            "pole", "land", "handrail", "escalator", "ottoman", "bottle", "buffet",
            "poster", "stage", "van", "ship", "fountain", "conveyer_belt", "canopy",
            "washer", "toy", "swimming_pool", "stool", "barrel", "basket", "waterfall",
            "tent", "bag", "minibike", "cradle", "oven", "ball", "food", "step",
            "storage_tank", "brand", "microwave", "flowerpot", "animal", "bicycle",
            "lake", "dishwasher", "screen", "blanket", "sculpture", "exhaust_hood", 
            "sconce", "vase", "traffic_light", "tray", "trash_can", "fan", "pier",
            "crt_screen", "plate", "monitor", "bulletin_board", "shower", "radiator",
            "drinking_glass", "clock", "flag"]
