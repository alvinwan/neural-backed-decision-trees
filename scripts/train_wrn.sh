...
do
  ...
  python main.py --lr=0.1 --dataset=TinyImagenet200 --model=wrn28_10 --path-graph=./data/TinyImagenet200/graph-induced-wrn28_10.json --tree-supervision-weight=10 --loss=${loss}
done;
